!(function (e, t) {
  ...
  function Md(e, t, n, r, o, a) {
    if (null !== e && Zu(e.memoizedProps, r) && e.ref === t.ref) {
      if (((Dd = !1), 0 == (a & o))) return (t.lanes = e.lanes), Yd(e, t, a)
      0 != (16384 & e.flags) && (Dd = !0)
    }
    return Pd(e, t, n, r, a)
  }
  function Cd(e, t, n) {
      ...
      case 22:
        ...
        if (null !== (t = null !== (t = n.updateQueue) ? t.lastEffect : null)) {
          ...
          do {
            var o = e
            ;(r = o.next),
              0 != (4 & (o = o.tag)) && 0 != (1 & o) && (Dv(n, e), Sv(n, e)),
              (e = r)
          } while (e !== t)
        }
        return
        ...
        try {
          for (y = e; null !== jp; ) {
            ...
            if ((36 & E && op(y, jp.alternate, jp), 128 & E)) {
              ...
              if (null !== S) {
                var D = jp.stateNode
                jp.tag, (b = D), 'function' == typeof S ? S(b) : (S.current = b)
              }
            }
            jp = jp.nextEffect
          }
  ...
  ;(Lp = function (e, t, n) {
    var r = t.lanes
    if (null !== e)
      if (e.memoizedProps !== t.pendingProps || tc.current) Dd = !0
      else {
        if (0 == (n & r)) {
          switch (((Dd = !1), t.tag)) {
            case 3:
  ...
  var Yw = function (e, t, n, r) {
      for (var o = -1, a = $w(Bw((t - e) / (n || 1)), 0), i = Array(a); a--; )
        (i[r ? a : ++o] = e), (e += n)
      return i
    },
    qw = Yw,
  ...
  var Xw = function (e) {
      return function (t, n, r) {
        return (
          r && 'number' != typeof r && Kw(t, n, r) && (n = r = void 0),
          (t = Qw(t)),
          void 0 === n ? ((n = t), (t = 0)) : (n = Qw(n)),
          (r = void 0 === r ? (t < n ? 1 : -1) : Qw(r)),
          qw(t, n, r, e)
        )
      }
    },
        ...
        f(n, [
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              return Gw(e, e + t).every(function (e) {
                return 1 === Zw(n, e)
              })
            },
          },
  ...
  function rk(e, t) {
    ...
    for (var n = 0; n < e.length; n++)
      if (((r = e[n]), (o = t[n]), !(r === o || (nk(r) && nk(o))))) return !1
    var r, o
    return !0
  }
  function ok(e, t) {
  ...
  lk.defaultProps = { minRows: 0, maxRows: 1 / 0 }
  var uk = function (e) {
      var t = e.label
      return se.createElement(
        'span',
        ...
        return (
          ...
          (e.renderWeek = function (t, n) {
            var r = e.props,
              ...
              g = h.rowLimit,
              y = fk(Lt(o), t[0], t[t.length - 1], d, c)
            return (
              y.sort(function (e, t) {
                return 1
              }),
          ...
          (e.readerDateHeading = function (t) {
            var n = t.date,
              ...
              v = e.props.components.dateHeader || sk
            return se.createElement(
              'div',
              Object.assign({}, o, {
  ...
  function vk(e) {
    for (
      var t = e.min,
        ...
        o = e.timeslots,
        a = e.localizer,
        i = pk({ start: t, end: n, step: r, timeslots: o, localizer: a }),
  ...
  var hk = Mg,
    mk = sg,
    gk = Ht ? Ht.isConcatSpreadable : void 0
  var yk = ug,
    bk = function (e) {
      return mk(e) || hk(e) || !!(gk && e && e[gk])
    }
  var wk = function e(t, n, r, o, a) {
    var i = -1,
      l = t.length
    for (r || (r = bk), a || (a = []); ++i < l; ) {
      var u = t[i]
  ...
  var Ck = Vb,
    ...
    jk = Sw,
    Ak = sg
  var Fk = function (e, t, n) {
    t = t.length
      ? Ck(t, function (e) {
          return Ak(e)
            ? function (t) {
                return Tk(t, 1 === e.length ? e[0] : e)
              }
            : e
        })
      : [jk]
    var r = -1
    t = Ck(t, zk(Pk))
    var o = Rk(e, function (e, n, o) {
      return {
        criteria: Ck(t, function (t) {
          return t(e)
        }),
        index: ++r,
        value: e,
  ...
  var Wk = function (e, t, n) {
    return (
      (t = Uk(void 0 === t ? e.length - 1 : t, 0)),
      function () {
        for (
          var r = arguments, o = -1, a = Uk(r.length - t, 0), i = Array(a);
          ++o < a;
  ...
  var Hk = function (e) {
    ...
    Bk = (function () {
      try {
        var e = Vk(Object, 'defineProperty')
        return e({}, '', {}), e
      } catch (e) {}
    })(),
    $k = Hk,
    ...
    for (
      var t = e.events,
        ...
        a = (function (e) {
          ...
          t.map(function (e) {
            return new aE(e, { slotMetrics: r, accessors: o })
          })
        ),
        i = [],
        l = function () {
  ...
  function fE(e) {
    ...
    var t = e.dayLayoutAlgorithm,
      n = t
    return t in sE && (n = sE[t]), cE(n) ? n.apply(this, arguments) : []
  }
  var dE = (function (e) {
    p(r, e)
    var n = g(r)
    ...
    var t = e.style,
      ...
      T = i(
        ...
        h
          ...
          : o(
              { top: pE(O), width: pE(_), height: pE(x) },
              l ? 'right' : 'left',
              pE(M)
            )
      )
  ...
  var hE = function (e) {
    ...
    mE = se.forwardRef(function (e, t) {
      return se.createElement(hE, Object.assign({}, e, { innerRef: t }))
    }),
    gE = ['dayProp'],
  ...
  var wE = function (e) {
      var t = e.min,
        ...
        h = E(
          x.useState(
            vk({ min: p, max: v, timeslots: r, step: o, localizer: a })
          ),
          2
        ),
        m = h[0],
    ...
    kE = se.forwardRef(function (e, t) {
      return se.createElement(wE, Object.assign({ gutterRef: t }, e))
    }),
    EE = function (e) {
      var t = e.label
  ...
  var OE = (function (e) {
    ...
    function n(e) {
      ...
      return (
        ...
        (r.memoizedResources = ok(function (e, t) {
          return (function (e, t) {
            return {
              map: function (n) {
                return e
  ...
  ;(PE.defaultProps = OE.defaultProps),
  ...
  ;(LE.defaultProps = OE.defaultProps),
    ...
    (jE.defaultProps = { length: 30 }),
    (jE.range = function (e, t) {
      var n = t.length,
        r = void 0 === n ? jE.defaultProps.length : n
      return { start: e, end: t.localizer.add(e, r, 'day') }
    }),
    (jE.navigate = function (e, t, n) {
      var r = n.length,
        o = void 0 === r ? jE.defaultProps.length : r,
        a = n.localizer
      switch (t) {
        case De.PREVIOUS:
            ...
            return se.createElement(
              ...
              se.createElement(
                ...
                se.createElement(
                  ...
                  {
                    type: 'button',
                    onClick: this.navigate.bind(null, De.TODAY),
                  },
                  t.today
                ),
                se.createElement(
                  ...
                  {
                    type: 'button',
                    onClick: this.navigate.bind(null, De.PREVIOUS),
                  },
                  t.previous
                ),
                se.createElement(
                  ...
                  {
                    type: 'button',
                    onClick: this.navigate.bind(null, De.NEXT),
                  },
                  t.next
                )
              ),
  ...
  var mS = function (e, t) {
    ...
    gS = ey(Object.getPrototypeOf, Object),
    yS = ug,
    bS = gS,
    wS = yg,
    kS = pg,
  ...
  var tx = wk
  var nx = function (e) {
      return (null == e ? 0 : e.length) ? tx(e, 1) : []
    },
    rx = Wk,
    ox = Xk
  var ax = Vb,
    ...
    sx = XE,
    cx = function (e) {
      return ex(e) ? void 0 : e
    },
    fx = CS,
    dx = (function (e) {
      return ox(rx(e, void 0, nx), e + '')
    })(function (e, t) {
      var n = {}
      if (null == e) return n
      var r = !1
      ;(t = ax(t, function (t) {
        return (t = ux(t, e)), r || (r = t.length > 1), t
      })),
        sx(e, fx(e), n),
        r && (n = ix(n, 7, cx))
      for (var o = t.length; o--; ) lx(n, t[o])
      return n
    }),
    px = eE,
    vx = At,
    ...
    bx = px(function (e, t) {
      ...
      var n = -1,
        r = t.length,
        o = r > 2 ? t[2] : void 0
      for (o && hx(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var a = t[n], i = mx(a), l = -1, u = i.length; ++l < u; ) {
          var s = i[l],
            c = e[s]
          ;(void 0 === c || (vx(c, gx[s]) && !yx.call(e, s))) && (e[s] = a[s])
        }
      return e
    }),
    wx = WE,
  ...
  var Tx = function (e, t, n) {
      ...
      if (((t = Sx(t)), null == n)) {
        ...
        n = o ? (r ? new a() : []) : Mx(e) && _x(a) ? kx(Dx(e)) : {}
      }
      return (
        (o ? wx : Ex)(e, function (e, r, o) {
          return t(n, e, r, o)
        }),
        n
      )
  ...
  var Lx = function (e) {
    ...
    jx = ['view', 'date', 'getNow', 'onNavigate'],
    Ax = [
      'view',
      'toolbar',
      'events',
    ...
    function o() {
      ...
      return (
        ...
        (e.handleViewChange = function (t) {
          t !== e.props.view && Ix(t, e.props) && e.props.onView(t)
          var n = e.getViews()
        ...
        (e.handleDrillDown = function (t, n) {
          ...
          r
            ...
            : (n && e.handleViewChange(n), e.handleNavigate(De.DATE, t))
        }),
  ...
  })(Ux, { view: 'onView', date: 'onNavigate', selected: 'onSelectEvent' })
  var Hx = function (e, t, n) {
    ...
    Vx = {
      ...
      dayFormat: 'DD ddd',
      weekdayFormat: 'ddd',
      selectRangeFormat: Hx,
      eventTimeRangeFormat: Hx,
  ...
  var Gx = function (e, t, n) {
    ...
    Jx = {
      ...
      dayFormat: 'eee dd/MM',
      weekdayFormat: 'eee',
      selectRangeFormat: Gx,
      eventTimeRangeFormat: Gx,
      eventTimeRangeStartFormat: function (e, t, n) {
        var r = e.start
  ...
  var kO = bO,
    ...
    SO = {
      ...
      dayFormat: 'DD ddd',
      weekdayFormat: 'ddd',
      selectRangeFormat: EO,
      eventTimeRangeFormat: EO,
      eventTimeRangeStartFormat: function (e, t, n) {
        var r = e.start
        return n.format(r, 'LT', t) + ' – '
      },
      ...
      agendaDateFormat: 'ddd MMM DD',
      agendaTimeFormat: 'LT',
      agendaTimeRangeFormat: EO,
    }
  function DO(e) {
    var t = e ? e.toLowerCase() : e
    return 'FullYear' === t ? (t = 'year') : t || (t = void 0), t
  }
  var xO = { eventWrapper: t, timeSlotWrapper: t, dateCellWrapper: t }
  ;(e.Calendar = Wx),
    (e.DateLocalizer = Pt),
    (e.Navigate = De),
    (e.Views = xe),
    ...
    (e.dayjsLocalizer = function (e) {
      ...
      return new Pt({
        ...
        sortEvents: function (e) {
          var t = e.evtA
          t.start, t.end, t.allDay
          var n = e.evtB
          return n.start, n.end, n.allDay, 1
        },
