!(function (e, t) {
    ...
    var t = e.style,
      ...
      T = i(
        ...
        h
          ...
          : o(
              { top: pE(O), width: pE(_), height: pE(D) },
              l ? 'right' : 'left',
              pE(M)
            )
      )
        ...
        if (h.current) {
          ...
          if (t) {
            var n,
              ...
              a = [],
              i = a
            ;(a = [xE(t.children[0]), xE(t.children[1])]),
              (i[0] === a[0] && i[1] === a[1]) ||
  ...
  ;(Ax[zx] =
    ...
    Ax['[object Uint32Array]'] =
      !0),
    (Ax['[object Error]'] = Ax[Lx] = Ax['[object WeakMap]'] = !1)
  var Fx = function e(t, n, r, o, a, i) {
    var l,
      u = 1 & n,
      s = 2 & n,
      c = 4 & n
    ...
    var f = _x(t)
    if (f) {
      if (((l = xx(t)), !u)) return yx(t, l)
    } else {
      var d = Sx(t),
        p = d == Lx || '[object GeneratorFunction]' == d
      if (Mx(t)) return gx(t, u)
      if (d == jx || d == zx || (p && !a)) {
        if (((l = s || p ? {} : Ox(t)), !u))
          return s ? wx(t, mx(l, t)) : bx(t, hx(l, t))
      } else {
        if (!Ax[d]) return a ? t : {}
        l = Dx(t, d, u)
      }
    ...
    var h = f ? void 0 : (c ? (s ? Ex : kx) : s ? Nx : Rx)(t)
    return (
      px(h || t, function (o, a) {
        h && (o = t[(a = o)]), vx(l, a, e(o, n, r, a, t, i))
      }),
      l
    )
  }
  ...
  var Wx = tw,
    ...
    Vx = function (e, t) {
      return t.length < 2 ? e : Ix(e, Ux(t, 0, -1))
    },
    Bx = rw
  var $x = function (e, t) {
      return (t = Wx(t, e)), null == (e = Vx(e, t)) || delete e[Bx(Hx(t))]
    },
    Yx = Zt,
    qx = gS,
    Kx = bn,
    ...
    Zx = Gx.call(Object)
  var eD = function (e) {
    if (!Kx(e) || '[object Object]' != Yx(e)) return !1
    var t = qx(e)
    if (null === t) return !0
    var n = Jx.call(t, 'constructor') && t.constructor
    return 'function' == typeof n && n instanceof n && Gx.call(n) == Zx
  }
  var tD = wk
  var nD = function (e) {
      return (null == e ? 0 : e.length) ? tD(e, 1) : []
    },
    rD = Wk,
    oD = Xk
  var aD = Vb,
    ...
    bD = pD(function (e, t) {
      ...
      var n = -1,
        r = t.length,
        o = r > 2 ? t[2] : void 0
      for (o && hD(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var a = t[n], i = mD(a), l = -1, u = i.length; ++l < u; ) {
          var s = i[l],
            c = e[s]
          ;(void 0 === c || (vD(c, gD[s]) && !yD.call(e, s))) && (e[s] = a[s])
        }
      return e
    }),
    wD = WE,
  ...
  var TD = function (e, t, n) {
      ...
      if (((t = SD(t)), null == n)) {
        ...
        n = o ? (r ? new a() : []) : MD(e) && _D(a) ? kD(xD(e)) : {}
      }
      return (
        (o ? wD : ED)(e, function (e, r, o) {
          return t(n, e, r, o)
        }),
        n
      )
  ...
  var LD = function (e) {
    ...
    jD = ['view', 'date', 'getNow', 'onNavigate'],
    AD = [
      'view',
      'toolbar',
      'events',
    ...
    function o() {
      ...
      return (
        ...
        (e.handleViewChange = function (t) {
          t !== e.props.view && ID(t, e.props) && e.props.onView(t)
          var n = e.getViews()
  ...
  var WD = (function e(t, n, r) {
    ...
    })(UD, { view: 'onView', date: 'onNavigate', selected: 'onSelectEvent' }),
    HD = function (e, t, n) {
      var r = e.start,
        o = e.end
  ...
  var KD = function (e, t, n) {
    ...
    QD = {
      ...
      dayFormat: 'ddd dd/MM',
      weekdayFormat: 'ddd',
      selectRangeFormat: KD,
      eventTimeRangeFormat: KD,
      eventTimeRangeStartFormat: function (e, t, n) {
        var r = e.start
        return n.format(r, 't', t) + ' – '
      },
